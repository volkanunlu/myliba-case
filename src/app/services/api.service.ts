...
export class ApiService {
  ...
  postUser(data:any){
    return this.http.post<any>("http://localhost:3000/userList/",data)  //yeni kullanıcı ekleme 
  }
  getUser(){
    return this.http.get<any>("http://localhost:3000/userList/") //mevcut kayıtları çekme 
  }
